...
#endif
const char* domoticz_port = "1883";
const char* mqtt_user = "alibabba";
const char* mqtt_password = "sesamopenu";
const char* OTAhost = "OTAESP32";
// just comment added for git test
#endif
